...
function addServerStyles(doc, appId, inline, external) {
  var _a2;
  const elements = (_a2 = doc.head) == null ? void 0 : _a2.querySelectorAll(`style[${APP_ID_ATTRIBUTE_NAME}="${appId}"],link[${APP_ID_ATTRIBUTE_NAME}="${appId}"]`);
  if (elements) {
...
var DefaultDomRenderer2 = class {
  ...
  listen(target, event, callback, options) {
    ...
    if ((_a2 = this.tracingService) == null ? void 0 : _a2.wrapEventListener) {
...
var ShadowDomRenderer = class extends DefaultDomRenderer2 {
  ...
  constructor(eventManager, sharedStylesHost, hostEl, component, doc, ngZone, nonce, platformIsServer, tracingService) {
    ...
    if (ngDevMode) {
      const baseHref = (_a2 = getDOM().getBaseHref(doc)) != null ? _a2 : "";
...
function createProvidersConfig(options) {
  var _a2;
  return {
    appProviders: [...BROWSER_MODULE_PROVIDERS, ...(_a2 = options == null ? void 0 : options.providers) != null ? _a2 : []],
...
var HttpRequest = class _HttpRequest {
  ...
  clone(update = {}) {
    ...
    const withCredentials = (_c = update.withCredentials) != null ? _c : this.withCredentials;
    const reportProgress = (_d = update.reportProgress) != null ? _d : this.reportProgress;
    let headers = update.headers || this.headers;
    let params = update.params || this.params;
    const context = (_e = update.context) != null ? _e : this.context;
...
function makeHttpResourceFn(responseType) {
  return function httpResource2(request, options) {
    ...
    const injector = (_a2 = options == null ? void 0 : options.injector) != null ? _a2 : inject(Injector);
...
function normalizeRequest(request, responseType) {
  ...
  return new HttpRequest((_a2 = unwrappedRequest.method) != null ? _a2 : "GET", unwrappedRequest.url, (_b2 = unwrappedRequest.body) != null ? _b2 : null, {
    headers,
    params,
...
function transferCacheInterceptorFn(req, next) {
  var _b2;
  const _a2 = inject(CACHE_OPTIONS), { isCacheActive } = _a2, globalOptions = __objRest(_a2, ["isCacheActive"]);
  ...
  !globalOptions.includeRequestsWithAuthHeaders && hasAuthHeaders(req) || ((_b2 = globalOptions.filter) == null ? void 0 : _b2.call(globalOptions, req)) === false) {
    return next(req);
  }
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZVMBXNL4.js.map
