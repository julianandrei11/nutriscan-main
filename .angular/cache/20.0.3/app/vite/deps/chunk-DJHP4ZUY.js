...
var OutletContext = class {
  ...
  get injector() {
    var _a2, _b2;
    return (_b2 = getClosestRouteInjector((_a2 = this.route) == null ? void 0 : _a2.snapshot)) != null ? _b2 : this.rootInjector;
  }
...
var ActivatedRoute = class {
  ...
  constructor(urlSubject, paramsSubject, queryParamsSubject, fragmentSubject, dataSubject, outlet, component, futureSnapshot) {
    ...
    this.title = (_b2 = (_a2 = this.dataSubject) == null ? void 0 : _a2.pipe(map((d) => d[RouteTitleKey]))) != null ? _b2 : of(void 0);
    this.url = urlSubject;
...
function getInherited(route, parent, paramsInheritanceStrategy = "emptyOnly") {
  ...
  !parent.component && !((_a2 = parent.routeConfig) == null ? void 0 : _a2.loadComponent))) {
    inherited = {
...
var Recognizer = class {
  ...
  processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects, parentRoute) {
    return from(routes).pipe(concatMap((r) => {
      var _a2;
      return this.processSegmentAgainstRoute((_a2 = r._injector) != null ? _a2 : injector, routes, r, segmentGroup, segments, outlet, allowRedirects, parentRoute).pipe(catchError((e) => {
        if (e instanceof NoMatch) {
          return of(null);
        }
        throw e;
...
This is currently a dev mode only error but will become a call stack size exceeded error in production in a future major version.`);
    ...
    const currentSnapshot = new ActivatedRouteSnapshot(segments, parameters, Object.freeze(__spreadValues({}, this.urlTree.queryParams)), this.urlTree.fragment, getData(route), getOutlet(route), (_b2 = (_a2 = route.component) != null ? _a2 : route._loadedComponent) != null ? _b2 : null, route, getResolve(route));
...
var _NavigationTransitions = class _NavigationTransitions {
  ...
  handleNavigationRequest(request) {
    ...
    (_a2 = this.transitions) == null ? void 0 : _a2.next(__spreadProps(__spreadValues({}, request), {
        ...
        return of(overallTransitionState).pipe(
          ...
          catchError((e) => {
            ...
            if (isNavigationCancelingError(e)) {
              ...
              const navigationError = new NavigationError(overallTransitionState.id, this.urlSerializer.serialize(overallTransitionState.extractedUrl), e, (_a2 = overallTransitionState.targetSnapshot) != null ? _a2 : void 0);
              try {
  ...
  isUpdatingInternalState() {
    var _a2, _b2;
    return ((_a2 = this.currentTransition) == null ? void 0 : _a2.extractedUrl.toString()) !== ((_b2 = this.currentTransition) == null ? void 0 : _b2.currentUrlTree.toString());
  }
  /**
  ...
  isUpdatedBrowserUrl() {
    ...
    const targetBrowserUrl = (_c = (_a2 = this.currentNavigation) == null ? void 0 : _a2.targetBrowserUrl) != null ? _c : (_b2 = this.currentNavigation) == null ? void 0 : _b2.extractedUrl;
...
var _StateManager = class _StateManager {
  ...
  createBrowserPath({
    ...
    const url = targetBrowserUrl != null ? targetBrowserUrl : rawUrl;
  ...
  resetInternalState({
    ...
    this.rawUrlTree = this.urlHandlingStrategy.merge(this.currentUrlTree, finalUrl != null ? finalUrl : this.rawUrlTree);
  }
};
...
var _HistoryStateManager = class _HistoryStateManager extends StateManager {
  ...
  get browserPageId() {
    ...
    return (_b2 = (_a2 = this.restoredState()) == null ? void 0 : _a2.ɵrouterPageId) != null ? _b2 : this.currentPageId;
  }
...
var _Router = class _Router {
  ...
  setUpLocationChangeListener() {
    var _a2;
    (_a2 = this.nonRouterCurrentEntryChangeSubscription) != null ? _a2 : this.nonRouterCurrentEntryChangeSubscription = this.stateManager.registerNonRouterCurrentEntryChangeListener((url, state, source) => {
...
var _RouterLink = class _RouterLink {
  ...
  subscribeToNavigationEventsIfNecessary() {
    ...
    createSubcription || (createSubcription = !this.queryParamsHandling && !dependsOnRouterState((_a2 = this.options) == null ? void 0 : _a2.defaultQueryParamsHandling));
  ...
  onClick(button, ctrlKey, shiftKey, altKey, metaKey) {
    ...
    (_a2 = this.router.navigateByUrl(urlTree, extras)) == null ? void 0 : _a2.catch((e) => {
  ...
  updateHref() {
    var _a2, _b2;
    const urlTree = this.urlTree;
    this.reactiveHref.set(urlTree !== null && this.locationStrategy ? (_b2 = (_a2 = this.locationStrategy) == null ? void 0 : _a2.prepareExternalUrl(this.router.serializeUrl(urlTree))) != null ? _b2 : "" : null);
  }
  ...
  preloadConfig(injector, route) {
    return this.preloadingStrategy.preload(route, () => {
      ...
      const recursiveLoadChildren$ = loadedChildren$.pipe(mergeMap((config) => {
        ...
        return this.processRoutes((_a2 = config.injector) != null ? _a2 : injector, config.routes);
      }));
...
function getBootstrapListener() {
  ...
  return (bootstrappedComponentRef) => {
    ...
    (_a2 = injector.get(ROUTER_PRELOADER, null, {
      optional: true
    })) == null ? void 0 : _a2.setUpPreloading();
    ...
    providers = [{
      ...
      useFactory: () => {
        ...
        return () => router.events.subscribe((e) => {
          var _a2, _b2;
          (_a2 = console.group) == null ? void 0 : _a2.call(console, `Router Event: ${e.constructor.name}`);
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-DJHP4ZUY.js.map
