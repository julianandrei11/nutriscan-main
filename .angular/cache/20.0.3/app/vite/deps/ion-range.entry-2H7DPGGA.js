...
var Range = class {
  ...
  render() {
    ...
    }, part: "label" }, label !== void 0 ? h("div", { class: "label-text" }, label) : h("slot", { name: "label" })), h("div", { key: "797d39ac73610f6d81d0b99d71982f98f2a66c88", class: "native-wrapper" }, h("slot", { key: "88824589cac5bb2134c30bed067ed11f6e81d887", name: "start" }), this.renderRangeSlider(), h("slot", { key: "7207a1164b272f56634435f7bff9114fb5d9f085", name: "end" }))));
  }
  get el() {
...
var renderKnob = (rtl, { knob, value, ratio, min, max, disabled, pressed, pin, handleKeyboard, pinFormatter, inheritedAttributes }) => {
  const start = rtl ? "right" : "left";
  const knobStyle = () => {
    const style = {};
...
@ionic/core/dist/esm/ion-range.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-range.entry-2H7DPGGA.js.map
