...
var __PRIVATE_LruScheduler = class {
  ...
  mr(e) {
    __PRIVATE_logDebug(xt, `Garbage collection scheduled in ${e}ms`), this.Vr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Vr = null;
      try {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
   ...
   */
  Ji(e) {
    return this.$i = (t) => __async(this, null, function* () {
  ...
  setDatabaseDeletedListener(e) {
    this.Ki.U((t) => __async(this, null, function* () {
  ...
  setNetworkEnabled(e) {
    ...
    this.xi.enqueueAndForget(() => __async(this, null, function* () {
      this.started && (yield this.Gi());
    })));
  }
  /**
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.Ki.runTransaction("shutdown", "readwrite", [H, pe], (e) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  start() {
    return __async(this, null, function* () {
      const e = yield this.syncEngine.Is();
      for (const t2 of e) {
  ...
  Zs(e) {
    ...
    if (t.storageArea === this.storage) {
      ...
      this.xi.enqueueRetryable(() => __async(this, null, function* () {
        if (this.started) {
          if (null !== t.key) {
            if (this.io.test(t.key)) {
              ...
              yield Promise.all(e2.map((e3) => this.syncEngine.vo(e3)));
            }
          }
        } else this.eo.push(t);
      }));
...
var __PRIVATE_PersistentStream = class {
  ...
  B_() {
    this.state = 5, this.x_.y_(() => __async(this, null, function* () {
...
function __PRIVATE_enableNetworkInternal(e) {
  return __async(this, null, function* () {
    if (__PRIVATE_canUseNetwork(e)) for (const t of e.Aa) yield t(
      /* enabled= */
      true
    );
  });
        ...
        yield function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            ...
            for (const r of t2.targetIds)
              e2.Ea.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2.Ea.delete(r), e2.ma.removeTarget(r));
          });
        }(e, t);
      } catch (n2) {
...
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    e.asyncQueue.enqueueRetryable(() => __async(null, null, function* () {
      __PRIVATE_logDebug(Xt, "Retrying IndexedDB access"), yield n(), e.da.delete(
        1
        /* OfflineCause.IndexedDbFailed */
    ...
    (yield function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
        if (function __PRIVATE_isPermanentWriteError(e3) {
          ...
          const n = e2.Ia.shift();
          __PRIVATE_ensureWriteStream(e2).L_(), yield __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  }), e.Aa.push((t) => __async(null, null, function* () {
    t ? (e.fa.L_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.Va.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (yield e.fa.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  }))), e.fa;
}
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.ga = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.ga.stop(), e.Ia.length > 0 && (__PRIVATE_logDebug(Xt, `Stopping write stream with ${e.Ia.length} pending writes`), e.Ia = []));
  }))), e.ga;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  complete() {
    return __async(this, null, function* () {
      const e = yield __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.Ka.id), t = this.Ga(this.documents);
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  return __async(this, null, function* () {
    e.fu = (t2, n2, r2) => function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    }), yield Promise.all(o), r.lu.Y_(i), yield function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    if (!n.currentUser.isEqual(t)) {
      ...
      n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.ks);
    }
  });
}
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.mu) {
      ...
      n.mu = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      }(n), n.mu = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r.hu.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
    ...
    return __async(this, null, function* () {
      try {
        ...
        for (; s; ) {
          ...
          e3 && n2._updateProgress(e3), s = yield t2.wu();
        }
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      this.serializer = __PRIVATE_newSerializer(e.databaseInfo.databaseId), this.sharedClientState = this.bu(e), this.persistence = this.Su(e), yield this.persistence.start(), this.localStore = this.Du(e), this.gcScheduler = this.vu(e, this.localStore), this.indexBackfillerScheduler = this.Cu(e, this.localStore);
    });
  }
  vu(e, t) {
    return null;
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.Fu.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Fu.syncEngine), yield __PRIVATE_fillWritePipeline(this.Fu.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      yield this.persistence.Ji((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.Fu.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  bu(e) {
    ...
    return __async(this, null, function* () {
      ...
      yield function __PRIVATE_remoteStoreShutdown(e2) {
        return __async(this, null, function* () {
          ...
          ), yield __PRIVATE_disableNetworkInternal(t2), t2.Ra.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  wu() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.Bu();
    });
  }
  /**
  ...
  qu(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.$u()) && this.ku("Reached the end of bundle when more is expected.");
      }
    ...
    return __async(this, null, function* () {
      ...
      const t = yield function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.Yo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
    ...
    return __async(this, null, function* () {
      ...
      e.forEach((e2, t) => {
        ...
        return __async(this, null, function* () {
          ...
          yield n.zo("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
        });
...
var __PRIVATE_TransactionRunner = class {
  ...
  Gu() {
    this.x_.y_(() => __async(this, null, function* () {
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
    ...
    n.xu(), e.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  ac() {
    return __async(this, null, function* () {
      if (0 !== this.Ju.length) {
        try {
          yield this.Ju[0](), this.Ju.shift(), this.x_.reset();
        } catch (e) {
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
      ...
      i2.xu(), e2.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
